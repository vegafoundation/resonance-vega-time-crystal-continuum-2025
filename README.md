...
| Language | File |
|----------|------|
| 🇩🇪 Deutsch | `paper/vega-time-crystal-continuum_de.tex` |
| 🇬🇧 English | `paper/vega-time-crystal-continuum_en.tex` |
| 🇹🇷 Türkçe | `paper/vega-time-crystal-continuum_tr.tex` |
| 🇸🇦 العربية | `paper/vega-time-crystal-continuum_ar.tex` |
| 🇷🇺 Русский | `paper/vega-time-crystal-continuum_ru.tex` |
| 🇪🇸 Español | `paper/vega-time-crystal-continuum_es.tex` |
| 🇨🇳 中文 | `paper/vega-time-crystal-continuum_zh.tex` |
| 🇻🇦 Latina | `paper/vega-time-crystal-continuum_la.tex` |
